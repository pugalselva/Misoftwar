            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="title">
                        ...
                        <p>
                            ReactJS Online Training will make you an expert in ReactJS
                            Programming to become a Professional Frontend Developer with
                            real-world projects. Learn ReactJS from scratch to build dynamic
                            and responsive web applications with Hands-on Demo Sessions.
                            This course will help you master ReactJS concepts like
                            components, state management, and hooks, along with practical
                            implementation of React Router and Redux. Gain in-depth knowledge
                            in creating interactive UIs and deploying web applications using
                            ReactJS with certified trainers and an updated syllabus. You will
                            become proficient in building modern web applications with our
                            ReactJS Online Training Course.
                        </p>
                    </div>
                        ...
                        <div class="corses-singel-image pt-50">
                            <img src="images/course/react.png" alt="Courses" />
                        </div>
                        <!-- corses singel image -->
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-description container">
                                        <div class="singel-description pt-4">
                                            <h6 class="text-primary">ReactJS Training Course Overview</h6>
                                            <p class="text-justify">
                                                This Comprehensive Online ReactJS Training will make you a Professional Frontend Developer, enabling
                                                you to build dynamic and responsive web applications. You will gain hands-on experience in creating
                                                React components, managing state, and leveraging the React ecosystem to deliver robust applications.
                                                The course also covers integration with APIs and tools to streamline development workflows.
                                            </p>
                                            <p class="text-justify">
                                                Learn how to develop interactive UIs, use React Router for navigation, and manage application state
                                                efficiently with tools like Redux. This training is designed for beginners and professionals who want to
                                ...
                                <div class="tab-pane fade" id="curriculam" role="tabpanel" aria-labelledby="curriculam-tab">
                                    <div class="curriculam-cont">
                                        <div class="title">
                                            <h6>ReactJS Course Content</h6>
                                        </div>
                                        <div class="accordion" id="accordionExample">
                                            <div class="module">
                                                <h2>Module 1: Introduction to ReactJS</h2>
                                                <ul>
                                                    <li>What is React and Why React?</li>
                                            ...
                                            <div class="module">
                                                <h2>Module 2: State and Lifecycle</h2>
                                                <ul>
                                                    <li>Understanding State in React</li>
                                                    <li>Lifecycle Methods</li>
                                                    <li>Handling Events</li>
                                                    <li>Using Functional and Class Components</li>
                                                </ul>
                                            </div>

                                            <div class="module">
                                                <h2>Module 3: React Router and Navigation</h2>
                                                <ul>
                                            ...
                                            <div class="module">
                                                <h2>Module 4: State Management with Redux</h2>
                                                <ul>
                                                    <li>Introduction to Redux</li>
                                                    <li>Actions, Reducers, and Store</li>
                                                    <li>Connecting Redux to React</li>
                                                    <li>Using Middleware like Thunk</li>
                                                </ul>
                                            </div>

                                            <div class="module">
                                                <h2>Module 5: Advanced React Concepts</h2>
                                                <ul>
                                                    <li>Context API</li>
                                            ...
                                            <div class="module">
                                                <h2>Module 6: Building and Deploying React Applications</h2>
                                                <ul>
                                                    <li>Working with APIs (REST and GraphQL)</li>
                                                    <li>Testing React Components</li>
                                                    <li>Optimizing React Applications</li>
                                                    <li>Deploying React Apps to Cloud</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
