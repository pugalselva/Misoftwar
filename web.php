        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="title">
                        <h3>Web Development Training Course</h3>
                        ...
                        <p>
                            Web Development Online Training will make you an expert in HTML, CSS, and JavaScript
                            programming to become a Professional Web Developer with
                            real-world projects. Learn web development from scratch to build dynamic
                            and responsive websites with Hands-on Demo Sessions.
                            This course will help you master HTML for structuring content, CSS for styling, and
                            JavaScript for interactivity. Gain practical knowledge in creating user-friendly
                            and accessible web pages, along with implementing modern design techniques.
                            You will become proficient in building modern web applications with our
                            Web Development Online Training Course led by certified trainers and an updated syllabus.
                        </p>
                    </div>
                        <!-- title -->
                        <!-- course terms -->
                        ...
                        <div class="corses-singel-image pt-50">
                            <img src="images/course/html.png" alt="Courses" />
                        </div>
                        <!-- corses singel image -->
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-description container">
                                        <div class="singel-description pt-4">
                                            <h6 class="text-primary">Web Development Training Course Overview</h6>
                                            <p class="text-justify">
                                                This Comprehensive Online Web Development Training will equip you with the skills to design and develop
                                                engaging websites. You will gain hands-on experience in HTML for structuring web content, CSS for styling,
                                                and JavaScript for adding interactivity to your applications. This course covers best practices for creating
                                                responsive and accessible web designs.
                                            </p>
                                            <p class="text-justify">
                                                Learn how to build professional-grade websites, integrate APIs, and leverage modern tools and frameworks to
                                                streamline your development workflow. This training is ideal for beginners and professionals looking to enhance
                                                their skills in frontend web development. Taught by experienced instructors, the course includes real-time
                                                projects and placement assistance.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="curriculam" role="tabpanel" aria-labelledby="curriculam-tab">
                                    <div class="curriculam-cont">
                                        <div class="title">
                                            <h6>Web Development Course Content</h6>
                                        </div>
                                        <div class="accordion" id="accordionExample">
                                            <div class="module">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>Understanding the Structure of a Web Page</li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="module">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>Working with Multimedia Elements</li>
                                            ...
                                            <div class="module">
                                                <h2>Module 4: JavaScript Fundamentals</h2>
                                                <ul>
                                            ...
                                            <div class="module">
                                                <h2>Module 5: Advanced Web Development Concepts</h2>
                                                <ul>
                                                    <li>Introduction to ES6 Features</li>
                                                    <li>Working with APIs</li>
                                                    <li>Debugging and Browser Developer Tools</li>
                                                    <li>Web Accessibility Standards</li>
                                                </ul>
                                            </div>

                                            <div class="module">
                                                <h2>Module 6: Building and Deploying Websites</h2>
                                                <ul>
                                                    <li>Creating a Complete Web Project</li>
