                ...
                <div class="col-lg-8">
                    <div class="corses-singel-left mt-30">
                        <div class="title">
                            ...
                            <p>
                                Python Online Training will make you an expert in Python
                                Programming Language to become a Professional Python Developer
                                with 10+ Real Time Projects. Learn Python & Django Framework
                                from the Scratch to build dynamic web applications with
                                Hands-on Demo Sessions. This Course will help you to learn
                                Python for Machine Learning, Al, Web development and Data
                                Science with Certified trainers and updated Syllabus. You will
                                gain In-depth Knowledge in Python game development using
                                Python 2 & Python 3 with our Python Online training Course.
                            </p>
                        </div>
                        <!-- title -->
                        <!-- course terms -->
                        ...
                        <div class="corses-singel-image pt-50">
                            <img src="images/course/py1.png" alt="Courses" />
                        </div>
                        <!-- corses singel image -->
                                ...
                                <div class="tab-pane fade show active" id="overview" role="tabpanel"
                                    ...
                                    <div class="overview-description container">
                                        <div class="singel-description pt-4">
                                            <h6 class="text-primary">Python Training Course Overview</h6>
                                            <p class="text-justify">
                                                This Comprehensive Online Python Training will make you a Professional
                                                Python Coder for building customized web apps and automating day-to-day
                                                manual tasks. You will gain knowledge on creating Machine Learning
                                                algorithms using Python to become a good ML engineer or Data Scientist.
                                                Python Training will enable you to work on Python with MySQL/PostgreSQL
                                                database projects to generate reports and charts with filters.
                                            </p>
                                            <p class="text-justify">
                                                The Complete Python Course Online for finance & accounts field to
                                                automate office works with the powerful Python programming to increase
                                                productivity. Basic to advanced level techniques on web scraping and
                                                data visualization with Python on Windows, Linux, and Mac environments
                                                taught by industry experts with placements through online classes with
                                ...
                                <div class="tab-pane fade" id="curriculam" role="tabpanel"
                                    ...
                                    <div class="curriculam-cont">
                                        ...
                                        <div class="accordion" id="accordionExample">
                                            ...
                                            <div class="module">
                                                <h2>Module 3: Functions and Modules</h2>
                                                <ul>
                                            ...
                                            <div class="module">
                                                <h2>Module 4: Data Structures</h2>
                                                <ul>
                                            ...
                                            <div class="module">
                                                <h2>Module 5: Object-Oriented Programming (OOP)</h2>
                                                <ul>Classes and Objects</li>
                                                    <li>Inheritance</li>
                                                    <li>Polymorphism</li>
                                                    <li>Encapsulation</li>
                                                </ul>
                                            ...
                                            <div class="module">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>Introduction to Libraries (e.g., NumPy, Pandas)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="You-makelike mt-30">
                                ...
                                <div class="singel-makelike mt-20">
                                    ...
                                    <div class="cont">
                                        <a href="#">
                                            <h4>Getting Started with Python: A Beginner's Guide</h4>
                                        </a>
                                        <ul>
                                            <li>
                                                <a href="#"><i class="fa fa-user"></i>31</a>
