            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Learn basic Spring Framework</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">Courses</a></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    Learn basic Spring Framework
                                </li>
                            </ol>
                        </nav>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="title">
                        <h3>Spring Framework Training Course</h3>
                        ...
                        <p>
                            Spring Framework Online Training will make you an expert in building robust and scalable enterprise-level applications. 
                            This course covers core concepts of the Spring Framework such as Dependency Injection, Aspect-Oriented Programming, Spring Boot, and Spring Security. 
                            Learn how to develop web applications using Spring MVC and connect them to databases with Spring Data. 
                            Gain hands-on experience with Spring Boot to quickly build microservices, and master best practices for Spring-based application development. 
                            This course is perfect for developers who want to advance their skills in Java development and become proficient in using Spring technologies. 
                            Led by certified trainers, this course offers real-world examples, updated syllabus, and practical demo sessions.
                        </p>
                    </div>
                        ...
                        <div class="corses-singel-image pt-50">
                            <img src="images/course/spring.png" alt="Courses" />
                        </div>
                        <!-- corses singel image -->
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-description container">
                                        <div class="singel-description pt-4">
                                            <h6 class="text-primary">Spring Framework Training Course Overview</h6>
                                            <p class="text-justify">
                                                This Comprehensive Online Spring Framework Training Course will equip you with the skills to develop enterprise-level Java applications using the Spring Framework. 
                                                You will gain hands-on experience in building web applications, implementing dependency injection, and managing application contexts. 
                                                The course covers core concepts like Spring Core, Spring MVC, and Spring Boot, enabling you to create robust and scalable applications.
                                            </p>
                                            <p class="text-justify">
                                                Learn how to work with Spring Beans, configure application contexts, and use Spring Boot for rapid application development. 
                                                This training is ideal for Java developers looking to deepen their knowledge of Spring and build modern, microservice-based applications. 
                                ...
                                <div class="tab-pane fade" id="curriculam" role="tabpanel" aria-labelledby="curriculam-tab">
                                    <div class="curriculam-cont">
                                        <div class="title">
                                            <h6>Spring Framework Course Content</h6>
                                        </div>
                                        <div class="accordion" id="accordionExample">
                                            <div class="module">
                                                <h2>Module 1: Introduction to Spring Framework</h2>
                                                <ul>
                                                    <li>Overview of Spring Framework</li>
                                                    <li>Setting Up the Spring Development Environment</li>
                                                    <li>Understanding Inversion of Control (IoC)</li>
                                                    <li>Introduction to Spring Beans and ApplicationContext</li>
                                                </ul>
                                            </div>

                                            <div class="module">
                                                <h2>Module 2: Core Spring Concepts</h2>
                                                <ul>
                                                    <li>Dependency Injection (DI)</li>
                                                    <li>Spring Bean Lifecycle</li>
                                                    <li>Configuration with XML and Annotations</li>
                                                    <li>Spring AOP (Aspect-Oriented Programming)</li>
                                                </ul>
                                            </div>

                                            <div class="module">
                                                <h2>Module 3: Spring MVC Framework</h2>
                                                <ul>
                                                    <li>Introduction to Spring MVC</li>
                                                    <li>Building Web Applications with Spring MVC</li>
                                                    <li>Controller, View, and Model in Spring MVC</li>
                                                    <li>Handling Forms and Validation in Spring MVC</li>
                                                </ul>
                                            </div>

                                            <div class="module">
                                                <h2>Module 4: Spring Boot</h2>
                                                <ul>
                                                    <li>Introduction to Spring Boot</li>
                                                    <li>Creating Spring Boot Applications</li>
                                            ...
                                            <div class="module">
                                                <h2>Module 5: Data Access with Spring</h2>
                                                <ul>
                                                    <li>Spring JDBC</li>
                                                    <li>JPA (Java Persistence API) with Spring</li>
                                                    <li>Working with Spring Data JPA</li>
                                                    <li>Transactions and Exception Handling in Spring</li>
                                                </ul>
                                            </div>

                                            <div class="module">
                                                <h2>Module 6: Spring Security</h2>
                                                <ul>
                                                    <li>Introduction to Spring Security</li>
                                                    <li>Authentication and Authorization</li>
                                                    <li>Securing Web Applications with Spring Security</li>
                                                    <li>Integrating Spring Security with OAuth2</li>
                                                </ul>
                                            </div>

                                            <div class="module">
                                                <h2>Module 7: Building Microservices with Spring</h2>
                                                <ul>
                                                    <li>Introduction to Microservices Architecture</li>
                                                    <li>Building Microservices with Spring Boot</li>
                                                    <li>Spring Cloud and Service Discovery</li>
                                                    <li>Inter-Service Communication and API Gateway</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="You-makelike mt-30">
                                ...
                                <div class="singel-makelike mt-20">
                                    ...
                                    <div class="cont">
                                        <a href="#">
                                            <h4>Introduction to Spring Framework</h4>
                                        </a>
                                        <ul>
                                            <li>
                                ...
                                <div class="singel-makelike mt-20">
                                    ...
                                    <div class="cont">
                                        <a href="#">
                                            <h4>How to Build Applications Using the Spring Framework</h4>
                                        </a>
                                        <ul>
                                            <li>
                                                <a href="#"><i class="fa fa-user"></i>31</a>
                                ...
                                <div class="singel-makelike mt-20">
                                    ...
                                    <div class="cont">
                                        <a href="#">
                                            <h4>Basic learn Spring Framework</h4>
                                        </a>
                                        <ul>
                                            <li>
                                                <a href="#"><i class="fa fa-user"></i>31</a>
